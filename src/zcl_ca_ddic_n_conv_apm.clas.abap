...
CLASS zcl_ca_ddic_n_conv_apm DEFINITION PUBLIC
                                  FINAL
                                  CREATE PUBLIC.
...
CLASS zcl_ca_ddic_n_conv_apm IMPLEMENTATION.
  ...
  METHOD constructor.
    ...
    zif_apack_manifest~descriptor =
         VALUE #(
            group_id        = 'itinere.at'
            artifact_id     = 'zca_ddic_n_conv'
            version         = '0.1.0'
            repository_type = 'abapGit'
            git_url         = 'https://github.com/JSB-Vienna/zca_ddic_n_conv.git'
            dependencies    =
                  VALUE #(
                      ( group_id       = 'itinere.at'
                        artifact_id    = 'zca'
